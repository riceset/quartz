      ...
      <div class="home-about-copy">
        ...
        <div
          ...
          style={{
            ...
            gap: "0.7rem",
            width: "11.5rem",
            margin: "2.5rem clamp(0.5rem, 2vw, 2rem) 0 auto",
            color: "var(--dark)",
          }}
        >
          <span
            class="home-about-signature-stroke"
            style={{
              display: "block",
              flex: "1 1 auto",
              height: "1px",
          ...
          ></span>
          <span
            class="home-about-signature-name"
            style={{
              display: "block",
              fontFamily: '"La Belle Aurore", "Segoe Print", "Bradley Hand", cursive',
              fontSize: "1.65rem",
              fontWeight: 400,
          ...
          <svg
            class="home-about-signature-mark"
            width="40"
            height="38"
            viewBox="0.18 2.31 61.37 58.57"
            fill="currentColor"
            focusable="false"
            style={{
              display: "block",
